...
1. Look through the [issues for this repo](https://github.com/filecoin-project/go-ds-versioning/issues) for relevant discussions.
...
1. If you like, check out [current PRs](https://github.com/filecoin-project/go-ds-versioning/pulls) to see how others do it.
